...
exports.default = (0, _createReactClass2.default)({
  ...
  getInitialState: function getInitialState() {
    ...
    var state = this.makeDateValues(this.props.value || this.props.defaultValue, this.props.minDate, this.props.maxDate);
  ...
  makeDateValues: function makeDateValues(isoString, minDateString, maxDateString) {
    var displayDate = void 0;
    var selectedDate = isoString ? new Date(isoString.slice(0, 10) + 'T12:00:00.000Z') : null;
    var minDate = minDateString ? new Date(minDateString.slice(0, 10) + 'T12:00:00.000Z') : null;
    var maxDate = maxDateString ? new Date(maxDateString.slice(0, 10) + 'T12:00:00.000Z') : null;
